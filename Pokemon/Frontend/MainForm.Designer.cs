namespace Pokemon
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.tabPageAttack.Controls.Add(this.comboBoxMove);
			...
			this.comboBoxMove.Location = new System.Drawing.Point(73, 29);
			this.comboBoxMove.Name = "comboBoxSkill";
			this.comboBoxMove.Size = new System.Drawing.Size(121, 20);
			this.comboBoxMove.TabIndex = 0;
			this.comboBoxMove.TextChanged += new System.EventHandler(this.comboBoxSkill_TextChanged);
			// 
			// buttonAttack
			// 
